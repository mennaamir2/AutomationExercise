...
public class ProductsPage {
    ...
    private By addToCartButton(String productName) {
        return By.xpath("//div[@class='productinfo text-center'][./p[text()='" + productName + "']]/a[contains(@class,'add-to-cart')]");
...
//        return this;
        driver.element().scrollToElementJS(addToCartButton(productName));
